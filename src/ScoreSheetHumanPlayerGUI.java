...
public class ScoreSheetHumanPlayerGUI extends Component implements ActionListener {
    ...
    ScoreSheetHumanPlayerGUI(HumanPlayer player) {
        ...
        int height = title_panel.getPreferredSize().height + button_panel.getPreferredSize().height + lowerPanel.getPreferredSize().height + messages.getPreferredSize().height;
        //System.out.println(height);
        mainPanel.setPreferredSize(new Dimension(600, height));
        //System.out.println(title_panel.getPreferredSize().height + " " + button_panel.getPreferredSize().height + " " + lowerPanel.getPreferredSize().height + " " + messages.getPreferredSize().height);
    }
